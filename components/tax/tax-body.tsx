      ...
      <div className="w-[90%] mx-auto">
        ...
        <div>
          <p className="capitalize leading-loose mb-6">
            ...
            from transacting on the Coins Exchange Services, and you acknowledge
            that Coins Exchange does not provide legal or tax advice relative to
            these transactions. If you have any doubts about your tax status or
            obligations when using Coins Exchange Services, or with respect to
            the Digital Assets held to the credit of your Coins Exchange
          ...
          <p className="capitalize leading-loose mb-6">
            ...
            may result in withholding taxes by Coins Exchange , to be remitted
