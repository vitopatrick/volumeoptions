      ...
      <div className="w-[90%] mx-auto">
        ...
        <div>
          <p className="capitalize leading-loose mb-6">
            ...
            from transacting on the Volume Options Services, and you acknowledge
            that Volume Options does not provide legal or tax advice relative to
            these transactions. If you have any doubts about your tax status or
            obligations when using Volume Options Services, or with respect to
            the Digital Assets held to the credit of your Volume Options
            account, you may wish to seek independent advice. You acknowledge
            that, when, where and as required by applicable legislation, Coins
            Exchange shall report information regarding your transactions,
            transfers, distributions or payments to tax or other public
            authorities
          </p>
          <p className="capitalize leading-loose mb-6">
            ...
            also prompt Volume Options to request you for additional tax
            ...
            may result in withholding taxes by Volume Options , to be remitted
