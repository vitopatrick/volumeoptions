  ...
  return (
    <>
      <div className="mx-2">
        ...
        <button
          onClick={showModal}
          className="my-4 text-gray_bg py-2 px-4 bg-card rounded font-sec font-semibold shadow-sm"
        >
          Update Address
        </button>
      </div>
