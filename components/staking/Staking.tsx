    ...
    <>
      <div className="md:grid grid-cols-3 gap-3 mx-2">
        ...
        {stakingOptions.map((opt) => (
          <div key={opt.id} className="bg-card p-4 rounded shadow my-4 md:my-0">
            {/* header (name and apr) */}
            ...
            <button
              ...
              className="mt-4 mb-2 font-sec inline-block bg-bg py-1 rounded text-white  w-full hover:bg-bg"
            >
              Stake now
            </button>
          </div>
