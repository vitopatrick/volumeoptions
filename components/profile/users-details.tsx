...
const UsersDetails = ({
  ...
  return (
    <>
      ...
      <div className=" md:grid grid-cols-2 gap-4 px-2">
        {/* grid children */}
        <div className="my-2 p-4 font-sec flex items-center gap-6 bg-card rounded shadow">
          {loading && <SkeletonCircle width={50} height={50} />}
          {!loading && (
            <div className="bg-bg p-3 md:p-5 rounded-full">
        ...
        <div className="my-2 p-4 font-sec flex items-center gap-6 bg-card rounded shadow">
          ...
          <div>
            ...
            <h1 className="font-bold text-base md:text-lg text-paper">xxxxx</h1>
          </div>
        </div>
      </div>
    </>
