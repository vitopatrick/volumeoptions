export const risks = [
  {
    ...
    body: `All terms used in this notice, which are defined in the Coins Exchange Terms of Use (the
“Terms of Use”), have the same meaning and construction as in the Terms of Use.`,
  },
  {
    heading: "B. Coins Exchange Services",
    body: `This notice provides you with information about the risks associated with Coins Exchange
Services. Each Coins Exchange Service has its own distinct risks. This notice provides a
general description of the risks when you use Coins Exchange Services.
...
decision to use Coins Exchange Services.
`,
  },
  {
...
No communication or information provided to you by Coins Exchange is intended as, or
...
`,
  },
  {
    ...
    body: `Coins Exchange is not your broker, intermediary, agent, or advisor and has no fiduciary
relationship or obligation to you in connection with any trades or other decisions or activities
undertaken by you using Coins Exchange Services. We do not monitor whether your use
of Coins Exchange Services is consistent with your financial goals and objectives. It is up
...
`,
  },
  {
    ...
    body: `We do not guarantee that the Coins Exchange Services will be available at any particular
time or that Coins Exchange Services will not be subject to unplanned service outages or
...
in the provision of Coins Exchange Services. You may be subject to the terms &
conditions of these third parties, and Coins Exchange may not be responsible for any loss
that these third parties may cause to you.`,
  },
  {
    heading: "K. Security Risk",
    body: `It is not possible for Coins Exchange to eliminate all security risks. You are responsible for
keeping your Coins Exchange Account password safe, and you may be responsible for all
the transactions under your Coins Exchange Account, whether you authorized them or
