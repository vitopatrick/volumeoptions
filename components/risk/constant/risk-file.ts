export const risks = [
  {
    ...
    body: `All terms used in this notice, which are defined in the Volume Exchange Terms of Use (the
“Terms of Use”), have the same meaning and construction as in the Terms of Use.`,
  },
  {
    heading: "B. Volume Exchange Services",
    body: `This notice provides you with information about the risks associated with Volume Exchange
Services. Each Volume Exchange Service has its own distinct risks. This notice provides a
general description of the risks when you use Volume Exchange Services.
...
decision to use Volume Exchange Services.
`,
  },
  {
...
No communication or information provided to you by Volume Exchange is intended as, or
...
`,
  },
  {
    ...
    body: `Volume Exchange is not your broker, intermediary, agent, or advisor and has no fiduciary
relationship or obligation to you in connection with any trades or other decisions or activities
undertaken by you using Volume Exchange Services. We do not monitor whether your use
of Volume Exchange Services is consistent with your financial goals and objectives. It is up
...
transacting on the Volume Exchange Services, and you acknowledge that Volume
Exchange does not provide legal or tax advice relative to these transactions. If you have
any doubts about your tax status or obligations when using Volume Exchange Services, or
with respect to the Digital Assets held to the credit of your Volume Exchange account, you
...
applicable law, Volume Exchange shall withhold taxes related to your transactions,
...
result in withholding taxes by Volume Exchange , to be remitted to tax authorities as defined
...
of rapid price movements.`,
  },
  {
    ...
    body: `Our fees and charges are set out here. Volume Exchange may, in its discretion, update the
...
`,
  },
  {
    ...
    body: `We do not guarantee that the Volume Exchange Services will be available at any particular
time or that Volume Exchange Services will not be subject to unplanned service outages or
...
in the provision of Volume Exchange Services. You may be subject to the terms &
conditions of these third parties, and Volume Exchange may not be responsible for any loss
that these third parties may cause to you.`,
  },
  {
    heading: "K. Security Risk",
    body: `It is not possible for Volume Exchange to eliminate all security risks. You are responsible for
keeping your Volume Exchange Account password safe, and you may be responsible for all
the transactions under your Volume Exchange Account, whether you authorized them or
