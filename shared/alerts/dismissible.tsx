...
const DismissibleAlert = ({ message, show, close }: DismissibleAlertProps) => {
  return (
    <div
      id="alert-1"
      className={
        show
          ? "flex p-4 mb-4 text-bg rounded-lg bg-gray_bg transition-all ease-in-out  mx-1 relative "
          : "hidden"
      }
      role="alert"
    >
      ...
      <div className="ml-3 text-sm font-main font-medium">{message}</div>
      <button
        type="button"
